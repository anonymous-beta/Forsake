...
pip install -q fastapi "uvicorn[standard]" pydantic bcrypt
...
if [[ "$DEV_MODE" == "false" ]]; then
    ...
    # Forsake Web Dashboard service (uses the chosen INSTALL_DIR)
...
ExecStart=${INSTALL_DIR}/venv/bin/python ${INSTALL_DIR}/forsake_server.py
Restart=always
RestartSec=5
