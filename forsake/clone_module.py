...
class LandingPageCloner:
    ...
    def clone(self, target_url: str, name: str = None) -> str:
        ...
        if rc == 0 or rc == 8:  # wget returns 8 for some server errors, may still have content
    ...
    def inject_tracking(self, page_dir: str, tracking_path: str = "/track") -> int:
        ...
        tracking_img = f'<img src="{tracking_path}" style="display:none;" alt=""/>'
        tracking_script = (
            '<script>\n'
            '(function() {\n'
            '  var img = new Image();\n'
            '  img.src = "' + tracking_path + '";\n'
    ...
    def modify_form_action(self, page_dir: str, original_action: str,
                           new_action: str) -> int:
        """
